...
classDiagram
    ...
    class ResourcePanel {
        ...
        +showResourceAnimation(String resourceType)
    }
    ...
    class TowerPanel {
        ...
        +updateTowerCosts()
        +showUpgradeOptions(Tower tower)
    }
    ...
    EntityManager *-- Map~String, List~Entity~~

    GameControlPanel o-- GameState
    ResourcePanel o-- GameState
    TowerPanel o-- GameState
``` 