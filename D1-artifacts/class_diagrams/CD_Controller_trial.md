classDiagram
    ...
    GameController --> MapSerializer
    GameController --> GameClock
    GameController --> InputHandler
    GameController --> GameOptions

    MapEditorController --> Map
    MapEditorController --> MapEditorScreen
    MapEditorController --> MapSerializer
    MapEditorController --> ValidationService

    OptionsController --> GameOptions
    OptionsController --> OptionsScreen
    OptionsController --> OptionsSerializer
    OptionsController --> ValidationService

    GameSession ..> WaveFactory
    WaveFactory ..> WaveConfiguration
    WaveFactory ..> GroupConfiguration

    MapSerializer --> FileManager
    OptionsSerializer --> FileManager
